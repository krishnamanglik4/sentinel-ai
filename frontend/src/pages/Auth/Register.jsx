    ...
    <div className="min-h-screen bg-[#080c14] text-slate-100 flex items-center justify-center p-4 bg-cyber-grid">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold font-outfit text-white">Create Security Account</h1>
          <p className="text-slate-400 text-xs mt-1">Get started with production AI fraud detection</p>
        </div>
